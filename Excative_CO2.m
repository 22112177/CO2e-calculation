...
%燃烧
ef_CH4 = [6,60,188,237];%焚烧CH4排放因子,kg/t
ef_N2O = 170;%焚烧N2O排放因子,kg/t
...
heat_cr = [0.06,0.11];%[0.147,0.073,0.005];%kgCO2e/MJ
...
%     end
%     CE_waste_fuel = CE_waste_fuel + waste_weight * waste_fuel * ef_CH4_r * 28 * 0.001;%单位吨，CH4排放
%     CE_waste_fuel = CE_waste_fuel + waste_weight * (1-water_content) * waste_content_dry(1)...
%         * extraction_efficiency(extraction_efficiency_r,1) * ef_N2O_r * 256 * 0.001;%单位吨，N2O排放
    ...
    F= CE_excavate*0.001 + CE_screen * 0.001 + CE_waste_fuel  ...
        + (CE_T_Fe + CE_T_plastic + CE_T_incinerator + CE_T_soil)*0.001 ...
