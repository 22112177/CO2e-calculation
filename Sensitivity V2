...
n=1*10^4;%运行次数
f=zeros(n,16);%开挖油耗；筛分；单位运输碳排放；T_Fe;T-plastic;T-otherwastefuel;T-soil;提取效率;substitution;Fe_cr;plastic_cr;soil_cr;heat_cr;w2e;heat
...
for i =1:n
    ...
    f(i,4) = transport_c_r;
    f(i,5) = distance_Fe_r;
    f(i,6) = distance_plastic_r;
    f(i,7) = distance_other_waste_fuel_r;
    f(i,8) = distance_coarse_soil_r;
    f(i,9) = extraction_efficiency_r;
    f(i,10) = substitution_factor_r;
    f(i,11) = Fe_cr_r;
    f(i,12) = plastic_cr_r;
    f(i,13) = soil_cr_r;
    f(i,14) = heat_cr_r;
